/*
  ...
  - You are about to drop the column `amount` on the `CategoryLimit` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "CategoryLimit" DROP COLUMN "amount",
